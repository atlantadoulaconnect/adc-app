...
class Cp2EmergencyContactsState extends State<Cp2EmergencyContacts> {
  ...
  void saveValidInputs() {
    ...
    String ec1Rel = _relationship1Ctrl.text.toString().trim();
    String ec1Phone1 = _phone1Ctrl.text.toString().trim();
    String ec1Phone2 = _altPhone1Ctrl.text.toString().trim();

    List<EmergencyContact> ecs = List();
    List<Phone> ec1Phones = List();

    // validate phone entries as "not empty" and "legit US numbers"
    if (ec1Phone1.isNotEmpty && phoneValidator(ec1Phone1) == null) {
      ec1Phones.add(Phone(ec1Phone1, true));
    }

    if (ec1Phone2.isNotEmpty && phoneValidator(ec1Phone2) == null) {
    ...
    ec1.name = nameValidator(ec1Name) == null ? ec1Name : null;
    ec1.relationship = ec1Rel.isEmpty ? null : ec1Rel;
    ec1.phones = ec1Phones.length > 0 ? ec1Phones : null;
    ...
    String ec2Rel = _relationship2Ctrl.text.toString().trim();
    String ec2Phone1 = _phone2Ctrl.text.toString().trim();
    String ec2Phone2 = _altPhone2Ctrl.text.toString().trim();

    List<Phone> ec2Phones = List();

    // validate phone entries as "not empty" and "legit US numbers"
    if (ec2Phone1.isNotEmpty && phoneValidator(ec2Phone1) == null) {
      ec2Phones.add(Phone(ec2Phone1, true));
    }

    if (ec2Phone2.isNotEmpty && phoneValidator(ec2Phone2) == null) {
    ...
    ec2.name = nameValidator(ec2Name) == null ? ec2Name : null;
    ec2.relationship = ec2Rel.isEmpty ? null : ec2Rel;
    ec2.phones = ec2Phones.length > 0 ? ec2Phones : null;
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            controller: _relationship1Ctrl
                              ..text =
                                  emgContactsPlaceholder(0, "relationship"),
                            validator: (val) {
                              if (val.isEmpty) {
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            controller: _relationship2Ctrl
                              ..text =
                                  emgContactsPlaceholder(1, "relationship"),
                            validator: (val) {
                              if (val.isEmpty) {
                                return "Please enter how this contact is related to you.";
                              }
