...
class RegisteredDoulasPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _RegisteredDoulasPageState();
}

class _RegisteredDoulasPageState extends State<RegisteredDoulasPage> {
  @override
  void initState() {
    super.initState();
  }
