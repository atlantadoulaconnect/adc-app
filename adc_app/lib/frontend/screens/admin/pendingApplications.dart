...
class PendingApplications extends StatelessWidget {
  ...
  PendingApplications(this.currentUser, this.toProfile)
...
class PendingApplicationsConnector extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return StoreConnector<AppState, ViewModel>(
      model: ViewModel(),
      builder: (BuildContext context, ViewModel vm) {
        return PendingApplications(vm.currentUser, vm.toProfile);
      },
    );
  }
}
